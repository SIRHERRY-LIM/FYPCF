...
class lecturer_register extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('Register/lecturer_register');
		} else {
			...
			$this->session->set_flashdata('message_lecturerregister', '<div class="alert alert-success alert-dismissible fade show" role="alert">
			...
			redirect('Register/lecturer_register');
		}
	}
}
